...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.player_1 = pygame.image.load("../images/player_1.png").convert()
        self.player_2 = pygame.image.load("../images/player_2.png").convert()
        self.player_3 = pygame.image.load("../images/player_3.png").convert()
        self.player_4 = pygame.image.load("../images/player_4.png").convert()
        while True:
            try:
